            ...
            <div class="card-body">
                <form action="biodata_sv.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="pob" class="form-control" id="pob" placeholder="Your Place of Birth">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" name="phone" class="form-control" id="phoneNumber" placeholder="Your Phone Number">
                    </div>
